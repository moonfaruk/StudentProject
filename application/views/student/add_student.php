...
<body>
	<form action="<?php echo base_url();?>index.php/students/add" method="post" role="form" class="form-horizontal"><br><br>
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div class="form-group">
						<h2 class="control-label col-md-7" >Add Student Form</h2>
					</div>
				</div>
			</div><br>
			<div class="row">
				<div class="col-md-8">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<textarea class="form-control" name="student_address" cols="4" rows="5"></textarea>
						</div>
					</div>
					<div class="form-group">
